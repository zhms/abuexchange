	...
	<div>
		<el-dialog :title="control_title" :visible.sync="dialog" width="380px" center>
			<el-form :inline="true" label-width="100px">
				<el-form-item label="概率修正值:">
					<el-input v-model="GameControl.CaptureAmendment"></el-input>
				</el-form-item>
			</el-form>
...
export default {
	...
	created() {
		this.show('HaiWangBuYu', (data) => {
			...
			this.setValue(this.GameControl, cfg, 'CaptureAmendment')
			this.dialog = true
		})
	},
	methods: {
