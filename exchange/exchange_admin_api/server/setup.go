...
func SetupDatabase() {
	...
	sql += "		GET CURRENT DIAGNOSTICS CONDITION 1	@errcode = MYSQL_ERRNO, @errmsg = MESSAGE_TEXT;\r\n"
	sql += "		ROLLBACK;\r\n"
	sql += "		INSERT INTO ex_error(FunName,ErrCode,ErrMsg)VALUES('ex_api_create_user',@errcode,@errmsg);\r\n"
	sql += "		SELECT @errcode AS errcode,@errmsg AS errmsg;\r\n"
	sql += "	END;\r\n"
	sql += "	##############################################################################################\r\n"
	...
	sql += "		LEAVE proc;\r\n"
	sql += "	END IF;\r\n"
	sql += "	INSERT INTO ex_user(UserId,SellerId,Account,`Password`,Email,PhoneNum)VALUES(@UserId,p_SellerId,p_Account,p_Password,@Email,@PhoneNum);\r\n"
